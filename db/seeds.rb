...
Salary.create!(tenure: darkwing.tenures.first, start_date: darkwing_start_date,
               annual_amount: '100000')
Salary.create!(tenure: darkwing.tenures.first, start_date: darkwing_start_date + 90,
...
Salary.create!(tenure: daisie.tenures.first, start_date: daisie_start_date,
...
Salary.create!(tenure: minnie.tenures.first, start_date: minnie_start_date,
...
Salary.create!(tenure: mickey.tenures.first, start_date: mickey_start_date,
...
Salary.create!(tenure: _donald.tenures.first, start_date: donald_start_date,
