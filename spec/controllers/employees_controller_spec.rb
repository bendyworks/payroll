...
describe EmployeesController do
  ...
  describe 'POST create' do
    describe 'with valid params' do
      let(:valid_attributes) {{ employee: attributes_for(:employee), tenure: { start_date: Time.zone.today } }}
      ...
      it 'creates a new Employee with the expected start date' do
        post :create, params: valid_attributes
        expect(assigns(:employee).start_date).to eq(valid_attributes[:tenure][:start_date])
      end
    ...
    describe 'with invalid params' do
      let(:invalid_attributes) {{ employee: attributes_for(:employee).merge(first_name: nil), tenure: { start_date: Time.zone.today } }}
